<?php
class Social_share_buttons_affiliate_program {
    ...
    public function admin_notices() {
        ...
        <div class="notice notice-info <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate">
            ...
            <a class="button button-primary <?php echo esc_attr($this->plugin_slug) ?>-affiliate-btn" target="_blank" href="https://premio.io/affiliates/?utm_source=inapp&plugin=social-share-buttons-popup&domain=<?php echo $_SERVER['HTTP_HOST'] ?>">Tell me more <span class="dashicons dashicons-arrow-right-alt"></span></a>
        </div>
...
$Social_share_buttons_affiliate_program = new Social_share_buttons_affiliate_program();